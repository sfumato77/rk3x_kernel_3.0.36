...
//mia #include <mach/map.h>   
//mia #include <mach/regs-clock.h>   
//mia #include <mach/regs-gpio.h>   
//mia #include <plat/gpio-cfg.h>   
#include <linux/gpio.h>       
//mia #include <mach/s3cfb.h>  

/********************************************************************/
//mia #include <plat/gpio-cfg.h>//add new 20140520
/********************************************************************/
//***************************PART1:ON/OFF define*******************************
...
#define GTP_COMPATIBLE_MODE   0//1    // compatible with GT9XXF
...
#define GTP_RST_PORT    RK30_PIN4_PD0//EXYNOS4_GPX0(6)//S5PV210_GPF0(1)//S5PV210_GPJ3(6)
#define GTP_INT_PORT    RK30_PIN4_PC2//EXYNOS4_GPX0(7)//S5PV210_GPH1(3)
...
//mia #define GTP_GPIO_AS_INPUT(pin)          gpio_direction_input(pin)
//mia #define GTP_GPIO_AS_INT(pin)            do{\
													gpio_direction_input(pin);\
...
#else
  #define GTP_MAX_HEIGHT   1024//4096
  #define GTP_MAX_WIDTH    600//4096
...
#define GTP_I2C_NAME                "ft5x0x_ts"  //"Goodix-TS"
