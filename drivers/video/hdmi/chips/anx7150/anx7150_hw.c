...
static u8 g_video_format = 0x00;
static u8 g_audio_format = 0x00;
...
void  HDMI_Set_Video_Format_anx7150(u8 video_format) //CPU set the lowpower mode
{	
    switch (video_format)
    {
        case HDMI_1280x720p_50Hz:
...
void  HDMI_Set_Audio_Fs_anx7150( u8 audio_fs) //ANX7150 call this to check lowpower
{
