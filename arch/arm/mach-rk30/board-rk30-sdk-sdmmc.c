...
//
    ...
    #if defined(CONFIG_RTL8192CU) || defined(CONFIG_RTL8188EU) || defined(CONFIG_RTL8723AU) || defined(CONFIG_RT5370)
    ...
    #define WIFI_HOST_WAKE RK30_PIN3_PD2
		...
		|| defined(CONFIG_RTL8189ES) || defined(CONFIG_MT7601) || defined(CONFIG_RT5370)
    //power
    #define RK30SDK_WIFI_GPIO_POWER_N               RK30_PIN3_PD0            
    #define RK30SDK_WIFI_GPIO_POWER_ENABLE_VALUE    GPIO_HIGH        
    //reset
