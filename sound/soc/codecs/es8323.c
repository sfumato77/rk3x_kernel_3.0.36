...
#define SPK_CTL             RK30_PIN0_PC7
#define EAR_CON_PIN         
#undef EAR_CON_PIN

#ifndef es8323_DEF_VOL
#define es8323_DEF_VOL			0x1d //思歌 0x1b
#endif
...
//  snd_soc_write(codec, ES8323_CONTROL2 , 0x40);   //
  ...
  snd_soc_write(codec, ES8323_ADCCONTROL10, 0xec);    // ALC stereo, Max gain(17.5dB), Min gain(0dB),updated by david-everest,5-25
  ...
  snd_soc_write(codec, ES8323_ADCCONTROL14, 0x73);    // NGTH(XXX), NGG(mute ADC output), NGAT(enable)
...
static int __init es8323_modinit(void)
{
    ...
    //set_codec_set_spk(codec_set_spk);
#endif
